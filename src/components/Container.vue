  ...
  <nav class="navbar is-dark">
    ...
    <div class="navbar-menu is-active">
      ...
      <div class="navbar-end">
        ...
        <a class="navbar-item" :class="active('overviewModal')" @click="toggle('overviewModal')" title="Seitenvorschau" v-if="$route.name !== 'synopsis'">
          <i class="fa fa-th"></i>
        </a>
          ...
          <div class="container">
            <div class="field">
              <label class="label has-text-light">
                Ihre Suchanfrage<br>
                z. B.  <i>10r</i>, <i>123</i> oder <i>NP 123</i>, <i>823.10[1]</i>, <i>Ep 2</i> oder <i>Pr 100</i> (nur Hs. V)
              </label>
